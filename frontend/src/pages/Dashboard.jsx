  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
      <PageHeader
        ...
        subtitle={
          isSystemAdmin
            ? "System administration and configuration overview"
            : isValidator
              ? "Absence overview for your team and upcoming validation impact"
              : "Overview of your absences and leave requests"
        }
      />
